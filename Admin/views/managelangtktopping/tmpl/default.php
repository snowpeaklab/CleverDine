	...
	<div class="span11">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<?php echo $vik->openControl(JText::_('VRMANAGELANG2').":"); ?>
				<input type="text" name="topping_name" value="<?php echo (empty($this->struct['topping_lang_name']) ? $this->struct['topping_name'] : $this->struct['topping_lang_name']); ?>" size="48"/>
			<?php echo $vik->closeControl(); ?>
			
			<?php if( $this->type == "edit" ) { ?>
				<input type="hidden" name="id_lang_topping" value="<?php echo $this->struct['id_lang_topping']; ?>"/>
			<?php } ?>
