...
<div class="container">
	...
	<?php if( cleverdine::canUserCancelOrder($order_details['checkin_ts'], 0) && $order_details['status'] == 'CONFIRMED' ) { ?>

		<div class="order-link">
			<div class="title"><?php echo JText::_('VRCANCELORDERTITLE'); ?></div>
			<div class="content">
				<a href="{cancellation_link}">{cancellation_link}</a>
			</div>
		</div>
