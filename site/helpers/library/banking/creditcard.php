 ...
 *
 * @see 	UILoader  	Used to load the files containing the classes of the brands.
 *
 * @since  	1.7
 */
abstract class CreditCard
{
	 ...
	 *
	 * @uses 	UILoader::import() 	to import brand files. 
	 */
	protected static function load($brand)
	{
		return UILoader::import('library.banking.brands.'.$brand);
	}
